...
image: "/og/nil-dispatch.png"
---

<ArticleByline title="NIL Athlete Financial Checklist" printChecklist />
...
- <BrandLogo logo="robinhood" /> **Robinhood** — best interface for beginners learning the basics of investing
- <BrandLogo logo="fidelity" /> **Fidelity** — best for long-term, serious money
- <BrandLogo logo="coinbase" /> **Coinbase** — if you're doing crypto, this is the safest mainstream option
...
- <BrandLogo logo="chase-card" size="sm" /> **Chase Freedom Unlimited®** — $0 fee, 1.5%–5% cash back, $300 bonus
- <BrandLogo logo="bankofamerica-card" size="sm" /> **Bank of America® Customized Cash Rewards** — $0 fee, up to 6% back
- <BrandLogo logo="amexgold" size="sm" /> **Amex Gold** — only once you've built solid credit. $325/yr fee
